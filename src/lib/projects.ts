export type Project = {
  slug: string;         // URL-friendly id  e.g. "library-management-system"
  name: string;         // display name
  desc: string;         // short description for cards
  longDesc: string;     // full description for detail page
  tech: string[];       // tech stack badges
  github: string;       // github link
  live: string;         // live demo link (empty string if none)
  gradient: string;     // tailwind gradient classes
  features: string[];   // key features list
  challenges: string;   // what you learned / challenges faced
};
...
export const projects: Project[] = [
  {
    ...
    longDesc:
      "A fully responsive personal portfolio built from scratch using Next.js 14 App Router, Tailwind CSS and Framer Motion. Features dark mode, custom cursor, page loader animation, scroll reveal effects and a working contact form powered by Resend.",
