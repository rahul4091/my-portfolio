...
const projects = [
  ...
  },
  {
    ...
    github: "https://github.com/rahul/todo-app",
    live: "https://rahul-todo.vercel.app",
  ...
  },
  {
    ...
    github: "https://github.com/rahul/blog",
    live: "https://rahul-blog.vercel.app",
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
                >
                  {/* GitHub icon */}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-lg bg-black dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
                >
                  {/* External link icon */}
